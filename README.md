# Reproduction du site HJC Helmets avec Tailwind + React
...
- Autres sections: aperçu de casques, section vidéo, section call to action, actualités, aperçu du compte Instagram
- Footer: Newsletter, liens de navigations et réseaux sociaux

## Application des concepts d'ergonomie
- Hiérarchie visuelle : titres grands (heading-1), sous-titres plus légers, boutons bien distincts
- Charge cognitive limitée : bon contraste (j'en ai ajouté un peu en assombrissant les fonds avec image car je trouvais que le contraste était mauvais), contenu épuré, deux CTA principaux (LEARN MORE), un secondaire (RELATED PRODUCT)
...
- Focus : éléments interactifs (liens et bouttons)
- Contraste : couleurs définies via @theme pour assurer la cohérence sur toute l'app
- Sémantique HTML : utilisation des balises pour démarquer la navbar, les sections, le footer et les titres (h1, h2, h3) pour une - structure claire et accessible aux lecteurs d'écran et renseignement des alt="" dans les images
